  ...
  },
  {
    ...
    steps: [
      ...
      { id: "oth-6", label: "AIの学習", href: "/paths/others/ai-foundation", summary: "AIに関する基本知識を学ぶ" },
      {
        id: "oth-3a",
        label: "アルゴリズムの問題集",
        href: "/paths/others/algorithm-set",
        summary: "Leetcodeにおけるアルゴリズムの練習",
        col: 2,
        row: -1,
        chain: false,
      },
...
const extraEdges: ExtraEdge[] = [
  ...
  { source: "oth-3", target: "oth-3a", sourceHandle: "top", targetHandle: "bottom", type: "straight", animated: true },
